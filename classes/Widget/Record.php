 ...
 * @since   1.0.0
 */
class Bandstand_Widget_Record extends WP_Widget {
	/**
	...
	public function __construct() {
		$widget_options = array(
			...
			'description'                 => esc_html__( 'Display a selected record', 'bandstand' ),
		);

		parent::__construct( 'bandstand-record', esc_html__( 'Record (Bandstand)', 'bandstand' ), $widget_options );
	}
	...
	public function widget( $args, $instance ) {
		...
		$image_size = apply_filters( 'bandstand_widget_record_image_size', 'thumbnail', $instance, $args );
		$image_size = apply_filters( 'bandstand_widget_record_image_size-' . $args['id'], $image_size, $instance, $args );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'post_id' ) ); ?>"><?php esc_html_e( 'Record:', 'bandstand' ); ?></label>
