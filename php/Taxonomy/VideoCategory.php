...
use Bandstand\Module\VideosModule;
 ...
 * @since   1.0.0
 */
class VideoCategory implements HookProviderInterface, PluginAwareInterface {
	 ...
	 * @since 1.0.0
	 *
	 * @param VideosModule $module Videos module.
	 */
	public function __construct( VideosModule $module ) {
		$this->module = $module;
	}
