...
namespace Bandstand\Taxonomy;

use Bandstand\HookProviderInterface;
use Bandstand\Module\DiscographyModule;
 ...
 * @since   1.0.0
 */
class RecordType implements HookProviderInterface, PluginAwareInterface {
	 ...
	 * @since 1.0.0
	 *
	 * @param DiscographyModule $module Discography module.
	 */
	public function __construct( DiscographyModule $module ) {
		$this->module = $module;
	}
