 ...
 * @since   1.0.0
 */
class MediaHooks implements HookProviderInterface, PluginAwareInterface {
	...
	public function register_image_editors( $editors ) {
		array_unshift( $editors, '\\Bandstand\\Image\\Editor\\GDEditor' );
		array_unshift( $editors, '\\Bandstand\\Image\\Editor\\ImagickEditor' );
