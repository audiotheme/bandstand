...
namespace Bandstand\Template;

use Bandstand\PluginInterface;
...
class TemplateManager {
	 ...
	 */
	public function __construct( PluginInterface $plugin, TemplateLoader $loader, TemplateCompatibility $compatibility ) {
		$this->plugin = $plugin;
		$this->loader = $loader;
