 ...
 * @since   1.0.0
 */
class Gig extends AbstractPost {
	/**
	 * Post type name.
	 *
	 * @since 1.0.0
	 ...
	 *
	 * Convenience wrapper around \Bandstand\Post\Gig::format_date_time().
	 *
	 * @since 1.0.0
	 *
	 ...
	 * Set the venue.
	 *
	 * The venue GUID is synchronized in \Bandstand\PostType\Gig::sync_venue_guid(),
	 * so that gig/venue connections can be remapped after an import.
	 *
	 * @since 1.0.0
	 *
	 * @param  int|\WP_Post|Venue $venue Venue ID, post object or venue object.
	 * @return Gig
	 */
