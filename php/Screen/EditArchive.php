...
use Bandstand\Module\ArchivesModule;
 ...
 * @since   1.0.0
 */
class EditArchive extends AbstractScreen {
	/**
	 * Archives module.
	 *
	 * @since 1.0.0
	 ...
	 * @since 1.0.0
	 *
	 * @param ArchivesModule $module Archives module.
	 */
	public function __construct( ArchivesModule $module ) {
		$this->module = $module;
	}
